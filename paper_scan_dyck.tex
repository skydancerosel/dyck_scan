...
\paragraph{Reproducibility.} All code is available at \url{https://github.com/skydancerosel/dyck_scan}. Total compute for full reproduction is approximately 24 hours on a single Apple M-series machine.
